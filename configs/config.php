...
* Site name
*/
$cfg['site']['name'] = "Contact Manager App";
/**
* Site owner name
*/
$cfg['site']['owner'] = "Semteacher Lab";
/**
* Page title
*/
...
* site address
*/
$cfg['site']['address'] = 'http://contactmgr.loc/';
/**
* company logo
*/
...
*/
$cfg['site']['contacts'] = array('Semteacher <semteacher@gmail.com>');
/**
* System email sender address
*/
$cfg['site']['email_sender'] = 'WebMaster <semteacher@gmail.com>';
...
$cfg['db']['username'] = 'contactmgr_user';
$cfg['db']['password'] = 'cont_pass';
/**
* The Default selected DB
*/
$cfg['db']['database'] = 'contactmgr';
...
*/
$cfg['php']['date.timezone'] = 'Ukraine/Kiev';
/**
* Mail function 
*/
